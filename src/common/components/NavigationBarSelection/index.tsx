...
const NavigationBarSelection = ({allItemsProgress,currentItemProgress}:NavigationBarSelectionProps) => {
    ...
    const percent = 100/(allItemsProgress.length -1)/2*(itemIndex+1+(itemIndex))
    return (
        <div className={styles.wrapper}>
            <div className={styles.content}>
                <div className={styles.mobile}>
                    <Typography variant='body4' color='white'>{currentItemProgress}</Typography> <AppColor.chevronBottom fill='white' width={'12px'} height={'6px'}/>
                </div>
                <PercentBar
