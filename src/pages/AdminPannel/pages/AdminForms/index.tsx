            ...
            <DynamicPadding />
               ...
               <div className='center_mobile_text'>
                <div className='gap_10'>
                    <div style={{width: 'auto'}}><Typography variant='titleBig' fontWeight='600' textTransform='uppercase'>Crypto Wallet Development partnerships</Typography></div>
               ...
               <div className={styles.top_part}>
                    ...
                    <Typography variant='body4' fontWeight='500' textTransform='uppercase' color={AppColor.transparentBlack}>partnership settings</Typography>
               </div>
